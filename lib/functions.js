...
//gw yg buat eh lu nya yg copas, mati sana anj
const spinner = { 
  "interval": 120,
  "frames": [
    `color("░░░░░░░","blue"), color("█","red"), color("꧁ʀᴀᴍᴅᴀɴɪɢᴀɴᴢ꧂","purple"), color("█","red"), color("░░░░░░░","blue")`, 
`color("░░░░░░","blue"), color("█▓","red"), color("꧁ʀᴀᴍᴅᴀɴɪɢᴀɴᴢ꧂","yellow"), color("▓█","red"), color("░░░░░░","blue")`, 
`color("░░░░░","blue"), color("█▓​▒","red"), color("꧁ʀᴀᴍᴅᴀɴɪɢᴀɴᴢ꧂","yellow"), color("▒▓█","red"), color("░░░░░","blue")`, 
`color("░░░░","blue"), color("█▓​▒","red"), color("░","blue"), color("꧁ʀᴀᴍᴅᴀɴɪɢᴀɴᴢ꧂","yellow"), color("░","blue"), color("▒▓█","red"), color("░░░░","blue")`, 
`color("░░░","blue"), color("█▓​▒","red"), color("░░","blue"), color("꧁ʀᴀᴍᴅᴀɴɪɢᴀɴᴢ꧂","yellow"), color("░░","blue"), color("▒▓█","red"), color("░░░","blue")`, 
`color("░░","blue"), color("█▓​▒","red"), color("░░░","blue"), color("꧁ʀᴀᴍᴅᴀɴɪɢᴀɴᴢ꧂","yellow"), color("░░░","blue"), color("▒▓█","red"), color("░░","blue")`, 
`color("░","blue"), color("█▓​▒","red"), color("░░░░","blue"), color("꧁ʀᴀᴍᴅᴀɴɪɢᴀɴᴢ꧂","yellow"), color("░░░░","blue"), color("▒▓█","red"), color("░","blue")`, 
`color("█▓​▒","red"), color("░░░░░","blue"), color("꧁ʀᴀᴍᴅᴀɴɪɢᴀɴᴢ꧂","yellow"), color("░░░░░","blue"), color("▒▓█","red")`, 
`color("█▓​","red"), color("░░░░░░","blue"), color("꧁ʀᴀᴍᴅᴀɴɪɢᴀɴᴢ꧂","yellow"), color("░░░░░░","blue"), color("▓█","red")`, 
`color("█","red"), color("░░░░░░░","blue"), color("꧁ʀᴀᴍᴅᴀɴɪɢᴀɴᴢ꧂","yellow"), color("░░░░░░░","blue"), color("█","red")`, 
`color("▓█​","red"), color("░░░░░░","blue"), color("꧁ʀᴀᴍᴅᴀɴɪɢᴀɴᴢ꧂","yellow"), color("░░░░░░","blue"), color("█▓​","red")`, 
`color("▒▓​█","red"), color("░░░░░","blue"), color("꧁ʀᴀᴍᴅᴀɴɪɢᴀɴᴢ꧂","yellow"), color("░░░░░","blue"), color("█▓​▒","red")`, 
